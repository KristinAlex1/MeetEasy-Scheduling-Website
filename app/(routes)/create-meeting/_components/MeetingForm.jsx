...
function MeetingForm({ setFormValue }) {
  ...
  const onCreateClick = async() => {
    ...
    await setDoc(doc(db, "Meeting-Event", id), {
        id:id,
        eventName: eventName,
      duration: duration,
      locationType: locationType,
  ...
  return (
    <div className="p-6">
      ...
      <div className="mt-4">
        <h2 className="font-bold text-2xl my-2">Create New Event</h2>
        <hr></hr>
      </div>
      <div className="flex flex-col gap-3 my-4">
        ...
        <DropdownMenu>
          <DropdownMenuTrigger>
            <Button className="max-w-40 float-start">
        ...
        <div className="grid grid-cols-4 gap-3">
          {LocationOption.map((option, index) => (
            ...
            >
              <Image alt="icon" src={option.icon} width={30} height={30} />
      ...
      <Button
        ...
        disabled={!eventName || !duration || !locationType || !locationUrl} onClick={() => onCreateClick()}
      >
        Create Event
      </Button>
    </div>
